...
## Bước 2.5 — Business State

Đọc và tóm tắt:
- Design Doc nào đang active? Status?
- PRD nào đang pending approval?
- Prototype nào đang review?
- Handoff nào đã giao cho dev?
...
- **Design Doc:** [tên] — [status: draft/approved/in-review]
- **PRD:** [tên] — [status]
- **Prototype:** [tên] — [status]
- **Handoff:** [tên] — [sent/pending]

## Assumptions Cần Validate
| Assumption | Status | Priority |
|------------|--------|---------|
| [assumption] | [pending/validated/blocked] | High/Med/Low |
...
Trước khi báo cáo, **hỏi bắt buộc:**

> "Chúng ta còn assumption nào chưa validate mà sẽ bắt đầu build dựa trên đó không?"

(Không được skip câu hỏi này)
...
Design state: [design/prototype status]
Assumptions pending: [list assumptions cần validate]
