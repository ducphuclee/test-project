...
Write the full plan document using the template below. Save to `backlog/docs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p backlog/docs/plans
```
...
```
backlog/docs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: backlog/docs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement backlog/docs/plans/{name}.plan.md` to execute this plan.
```
